...
- The recall check presents one question at a time and advances on each answer tap, then reveals the score and lets you play again at the same speed or choose a new one. The local stats view groups quiz accuracy by measured 100-wpm speed bands and keeps a chronological, source-linked article log.
